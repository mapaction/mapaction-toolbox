...
Module testingCommandline
    ...
    Sub Main(ByVal CmdArgs() As String)
        Dim dataListPath As String
        Dim lookupTablesPath As String
        Dim namesToTest As New List(Of String)
        ...
        Try
            ...
            For Each testStr In namesToTest
                status = dncl.getNameStatus(testStr)
                System.Console.WriteLine()
                System.Console.WriteLine("********************************************************")
                System.Console.WriteLine("DATA NAME:  " & testStr)
                System.Console.WriteLine("********************************************************")
